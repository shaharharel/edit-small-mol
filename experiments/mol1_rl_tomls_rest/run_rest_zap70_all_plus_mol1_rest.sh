...
set -eo pipefail
LOG="$HOME/rest_zap70_all_plus_mol1_rest.log"
date -u +"[%FT%TZ] mol1RL_v5_seed_zap70_all_plus_mol1_rest START (REST)" | tee -a "$LOG"
...
# Run RL
work=/home/shaharh_quris_ai/edit-small-mol/results/paper_evaluation/mol1_rl/mol1RL_v5_seed_zap70_all_plus_mol1_rest
rm -rf "$work"; mkdir -p "$work"
cd "$work"
cp /home/shaharh_quris_ai/edit-small-mol/experiments/mol1_rl_tomls_rest/mol1RL_v5_seed_zap70_all_plus_mol1_rest.toml .
date -u +"[%FT%TZ] RL launching" | tee -a "$LOG"
timeout 5400 reinvent ./mol1RL_v5_seed_zap70_all_plus_mol1_rest.toml -d cuda 2>&1 | tee -a "$LOG" || {
